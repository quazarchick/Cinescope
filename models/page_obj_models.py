...
class PageAction:
    ...
    def wait_redirect_for_url(self, url: str):
        ...
        assert self.page.url == url, "Редирект на домашнюю страницу не произошёл"
...
class CinescopLoginPage(BasePage):
    ...
    def wait_redirect_to_homepage(self):
        self.page.wait_for_url("https://dev-cinescope.coconutqa.ru/")
        assert self.page.url == "https://dev-cinescope.coconutqa.ru/", "Редирект не произошел"
