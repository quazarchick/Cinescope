...
class TestUser:
    ...
    def test_get_user_by_locator(self, super_admin, creation_user_data):
        ...
        get_by_email = super_admin.api.user_api.get_user(create_user_response_data.email)
        ...
        assert response_by_id.fullName == creation_user_data.fullName, "ФИО не совпадает"
    ...
    def test_delete_user(self, super_admin, creation_user_data):
        ...
        repeat_delete_user = super_admin.api.user_api.delete_user(response_creation_user.id,expected_status=404)
